				...
				<div>
					<table>
						<tr>
							...
							<td>
								<fieldset style="width:300px; height:300px;">
									...
									<table>
										<tr>
											<ul>
												<li><a href="/Project1/View/studentlist.php">Student List</a></li>
							...
							<td>
								<form action="/Project1/Controller/editmanagerControl.php" target="_self" method="post" onsubmit="return valideditstudent(this)" novalidate>
						            <fieldset style="width: 30em;">
						                <legend><h3>Add Manager</h3></legend>
						                <?php
