        ...
        <div class="right">
            <div class="slideshow-container">
                ...
                <div class="mySlides fade">
                    ...
                    <img src="../ProjectDH/View/img/1.jpg" style="width: 100%;">
                    <div class="text" style="color:black">Sell Your Property</div>
                </div>

                <div class="mySlides fade">
                    <div class="numbertext">2 / 3</div>
                    <img src="../ProjectDH/View/img/2.jpg" style="width: 40%;">
                    <div class="text" style="color:black">Need a House?</div>
                </div>

                <div class="mySlides fade">
                    <div class="numbertext">3 / 3</div>
                    <img src="../ProjectDH/View/img/3.jpg" style="width: 70%;">
                    <div class="text" style="color:black">Get Your Own House</div>
                </div>
