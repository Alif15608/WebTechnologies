...
<body>
	...
	<div>
		<fieldset>
			<form>
            <p style="font-size: 25px;" align='center'><b>Manager Details</b> </p>
				<div>
					<table>
						<tr>
                ...
                <div class="table-responsive" > 
                     <table class="table table-bordered" border="1px">  
                          ...
                          <?php   
                          $data = file_get_contents("../Model/manager.json");  
                     ...
                     <a href="/Mid Project/Controller/loginAction.php">Add Manager</a><br>
