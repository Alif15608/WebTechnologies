						...
						<tr>
							<td style="width:300px;">
								...
								<ul>
									...
									<li><a href="/Project1/View/addapartment.php">View Apartment</a></li>
							...
							<td>
								<form action="/Project1/Controller/addmanagerControl.php" target="_self" method="post" onsubmit="return validstudent(this)" novalidate>
